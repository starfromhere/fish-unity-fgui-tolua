...
namespace FairyGUI
{
    ...
    public class DisplayObject : EventDispatcher
    {
        ...
        public void ChangeBlendMode(int mode){
            switch(mode){
                case 1: _blendMode = BlendMode.Normal;break;
                case 2: _blendMode = BlendMode.None;break;
                case 3: _blendMode = BlendMode.Add;break;
                case 4: _blendMode = BlendMode.Multiply;break;
                case 5: _blendMode = BlendMode.Screen;break;
                case 6: _blendMode = BlendMode.Erase;break;
                case 7: _blendMode = BlendMode.Mask;break;
                case 8: _blendMode = BlendMode.Below;break;
                case 9: _blendMode = BlendMode.Off;break;
            }
        }
        /// <summary>
        /// 
