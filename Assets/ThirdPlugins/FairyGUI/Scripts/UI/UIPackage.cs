...
namespace FairyGUI
{
    ...
    public class UIPackage
    {
        ...
        public static LoadResource LoadFromResPath = (string name, string extension, System.Type type, out DestroyMethod destroyMethod) =>
        {
            destroyMethod = DestroyMethod.Unload;
            ...
            return libx.Assets.LoadAsset(name + extension, type).asset;
        };
