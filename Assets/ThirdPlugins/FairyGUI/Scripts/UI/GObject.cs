...
namespace FairyGUI
{
    public class GObject : EventDispatcher
    {
        ...
        public void ChangeBlendMode(int mode){
            ...
            switch(mode){
                case 1: value = BlendMode.Normal;break;
                case 2: value = BlendMode.None;break;
                case 3: value = BlendMode.Add;break;
                case 4: value = BlendMode.Multiply;break;
                case 5: value = BlendMode.Screen;break;
                case 6: value = BlendMode.Erase;break;
                case 7: value = BlendMode.Mask;break;
                case 8: value = BlendMode.Below;break;
                case 9: value = BlendMode.Off;break;
            }
