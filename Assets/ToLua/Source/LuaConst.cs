...
{
    public static string luaDir = Application.dataPath + "/Src/Lua";                        //lua逻辑代码目录//lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/ToLua/ToLua/Lua";              //tolua lua文件目录
    
    public static string luaApiDir = Application.dataPath + "/Src/LuaApi/";             //luaApiDir lua文件目录

#if UNITY_STANDALONE_WIN
    public static string osDir = "Windows";
#elif UNITY_STANDALONE_OSX
    public static string osDir = "OSX";
#elif UNITY_ANDROID
    ...
    public static bool openJson = true;                 //是否使用cjson
}