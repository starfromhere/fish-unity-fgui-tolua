...
public class FairyGUI_UIPackageWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("LoadFromResPath", get_LoadFromResPath, set_LoadFromResPath);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_LoadFromResPath(IntPtr L)
	{
		try
		{
			ToLua.Push(L, FairyGUI.UIPackage.LoadFromResPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_LoadFromResPath(IntPtr L)
	{
		try
		{
			FairyGUI.UIPackage.LoadResource arg0 = (FairyGUI.UIPackage.LoadResource)ToLua.CheckDelegate<FairyGUI.UIPackage.LoadResource>(L, 2);
			FairyGUI.UIPackage.LoadFromResPath = arg0;
			return 0;
		}
		catch (Exception e)
		{
