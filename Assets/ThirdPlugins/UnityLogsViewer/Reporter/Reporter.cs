...
public class Reporter : MonoBehaviour
{
    ...
    void OnGUI()
    {
	    ...
	    if (!show)
	    {
		    if (GUI.Button(new Rect(30, 10, 180, 100), "V: "+Application.version.ToString(), fontStyle))
		    {
			    debugRet = !debugRet;
		    }
	    }
...
//		}
	...
	void DrawInfo()
	{
		...
		GUILayout.Box( showSceneContent ,nonStyle ,  GUILayout.Width(size.x) , GUILayout.Height(size.y));
		GUILayout.Space( size.x);
		GUILayout.Label( "App Version: " + Application.version.ToString() , nonStyle , GUILayout.Height(size.y));
		GUILayout.FlexibleSpace();
		GUILayout.EndHorizontal();
